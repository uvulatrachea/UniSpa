...
export default function AdminLogin() {
  ...
  const submit = (e) => {
    ...
    // routes/web.php: Route::post('/admin/login')->name('admin.login.store')
          ...
          <div className="grid min-h-[640px] grid-cols-1 lg:grid-cols-12">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-center text-center">
                ...
                <h1 className="text-3xl font-bold xl:text-4xl">UniSpa Admin</h1>
                <p className="mt-4 text-sm opacity-90 xl:text-base">Private access portal for authorised administrators only</p>
              </div>
            </div>
            ...
            <div className="col-span-1 flex flex-col justify-center p-5 sm:p-8 md:p-10 lg:col-span-7 lg:p-12">
              <div className="mb-7 text-center lg:hidden">
                ...
                <p className="text-xs uppercase tracking-[0.2em] text-unispa-subtle">Admin Portal</p>
              </div>

              <h2 className="mb-2 text-2xl font-bold sm:text-3xl">Admin Login</h2>
              <p className="mb-6 text-sm text-unispa-subtle sm:text-base">Sign in to manage staff, schedules and service operations</p>
              ...
              <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-700 sm:text-sm">
                Security notice: this portal is monitored and restricted to active Admin accounts only.
              </div>
            </div>
          </div>
        </div>
